package com.bank.bian.securitiessettlement.model;
...
/**
 * The BIAN control record for this service domain: "Securities Settlement Procedure".
 *
 ...
 * to its asset type (Securities Settlement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Securities Settlement Procedure";
